...
\R{Thanks for the suggestion. We have added an explicit comparison with latent action models in Sec.~II-B.
...
predictor outputs a complete future token sequence aligned with the visual target, so Eq.~(7) forms
