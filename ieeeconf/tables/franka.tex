...
\begin{table*}[!t]
\centering
\caption{\textbf{Results on Franka Kitchen~\cite{franka_kitchen}}. All rows use the same frozen-backbone behavioral-cloning downstream protocol, while the backbone and pre-training dataset columns expose the upstream data/model differences. Baselines are grouped by representation paradigm; success rates are reported in percent and the best result in each task column is bolded.}
\setlength{\tabcolsep}{3pt}
\resizebox{\textwidth}{!}{%
